...
class Entry(models.Model):
    ...
    created_by = UserelField(_('created by'), auto_now_add=True, related_name='entries_create')
    updated_by = UserelField(_('updated by'), auto_now=True, related_name='entries_update')
